...
namespace DesignPatterns
{
    ...
    public class ExtendStringBuilder
    {
        ...
        public static implicit operator ExtendStringBuilder(string s)
        {
            var esb = new ExtendStringBuilder();
            esb.sb.Append(s);
            return esb;
        }

        public static ExtendStringBuilder operator +(ExtendStringBuilder esb, string s)
        {
            esb.Append(s);
            return esb;
        }
    ...
    public class ColorShape : IShape
    {
        ...
        public string AsString()
        {
            return $"{_shape.AsString()} has color {_color}";
        }
    }
    ...
    public class TransparentShape : IShape
    {
        ...
        public string AsString()
        {
            return $"{_shape.AsString()} has {_transparency*100.00}% transparency";
        }
    }
